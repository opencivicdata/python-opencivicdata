    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', opencivicdata.models.base.OCDIDField(ocd_type='disclosure', validators=[django.core.validators.RegexValidator(regex='^ocd-disclosure/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}$', flags=32, message='ID must match ^ocd-disclosure/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}$')], serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', uuidfield.fields.UUIDField(unique=True, editable=False, max_length=32, blank=True, serialize=False, primary_key=True)),
                ('name', models.CharField(max_length=2000)),
                ('entity_type', models.CharField(max_length=20, blank=True)),
                ('disclosure', models.ForeignKey(to='opencivicdata.Disclosure', related_name='authority')),
        ...
        migrations.CreateModel(
            name='DisclosureDisclosedEvent',
            fields=[
                ('id', uuidfield.fields.UUIDField(unique=True, editable=False, max_length=32, blank=True, serialize=False, primary_key=True)),
                ('name', models.CharField(max_length=2000)),
                ('entity_type', models.CharField(max_length=20, blank=True)),
                ('disclosure', models.ForeignKey(to='opencivicdata.Disclosure', related_name='disclosed_events')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=2000)),
                ('entity_type', models.CharField(max_length=20, blank=True)),
                ('disclosure', models.ForeignKey(to='opencivicdata.Disclosure', related_name='registrant')),
                ('organization', models.ForeignKey(null=True, to='opencivicdata.Organization')),
                ('person', models.ForeignKey(null=True, to='opencivicdata.Person')),
            ],
            options={
        ...
        migrations.AlterField(
            ...
            name='classification',
            field=models.CharField(blank=True, max_length=100, choices=[('legislature', 'Legislature'), ('executive', 'Executive'), ('upper', 'Upper Chamber'), ('lower', 'Lower Chamber'), ('party', 'Party'), ('committee', 'Committee'), ('commission', 'Commission'), ('office', 'Office'), ('company', 'Company')]),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='organization',
